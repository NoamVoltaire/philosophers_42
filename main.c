...
/*   Updated: 2024/09/07 18:02:10 by noam             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	**********************************************************************	*/
/*
** add a bool to sticks to know if the stick mutexes are locked or not
** add a way to know if the stick is locked or not before trying to lock it, else drop previous fork and wait a bit
*/
